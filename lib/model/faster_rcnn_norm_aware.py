...
#from .proposal_target_layer_cascade import ProposalTargetLayer
...
class FasterRCNN_NormAware(GeneralizedRCNN):
    ...
    def __init__(self, backbone,
        ...
        #proposal_target_layer = _ProposalTargetLayer(2)
        proposal_target_layer = None
        roi_heads = self._set_roi_heads(
            ...
            bbox_reg_weights,
            box_score_thresh, box_nms_thresh, box_detections_per_img, proposal_target_layer)
...
class NormAwareRoiHeads(RoIHeads):
    ...
    def __init__(self, embedding_head, reid_loss, *args, **kwargs):
        ...
        #self.RCNN_proposal_target = proposal_target_layer
    ...
    def forward(self, features, proposals, image_shapes, targets=None):
        ...
        if self.training:
            ...
            #proposals, labels, regression_targets = self.RCNN_proposal_target(proposals, targets)
